...
**0.1.0.11** — dedicated MP: grass scan reentrancy fix; visible sync deny + list refresh after adopt; `ftdlSync`/`ftdlOwned`; Farm.PERMISSION `ftdlEditTodos` (ESC grants hidden).
